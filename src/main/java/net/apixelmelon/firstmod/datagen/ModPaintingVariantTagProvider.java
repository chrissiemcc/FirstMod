...
public class ModPaintingVariantTagProvider extends PaintingVariantTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        this.tag(PaintingVariantTags.PLACEABLE)
                .addOptional(new ResourceLocation(FirstMod.MOD_ID, "saw_them"))
                .addOptional(new ResourceLocation(FirstMod.MOD_ID, "shrimp"))
                .addOptional(new ResourceLocation(FirstMod.MOD_ID, "world"));
    }
}
