...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, END_SAPPHIRE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.END_SAPPHIRE_ORE_KEY),
                ModOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        //pCount is the amount of ore veins per chunk
        //VerticalAnchor determines the y level the ore will spawn
        //.uniform is equal generation between the two y levels specified. This can be replaced with .triangle for generation to be
        //rare at either end but common in the centre of the two y levels.
    }
