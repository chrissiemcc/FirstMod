package net.apixelmelon.firstmod.particle;
...
public class SapphireParticles extends TextureSheetParticle {
    protected SapphireParticles(ClientLevel pLevel, double pX, double pY, double pZ,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double pX, double pY, double pZ,
            ...
            return new SapphireParticles(level, pX, pY, pZ, this.spriteSet, pXSpeed, pYSpeed, pZSpeed);
        }
    }
}
