...
public class APixelMelonFurnaceRecipe extends AbstractCookingRecipe {
    public APixelMelonFurnaceRecipe(ResourceLocation pId, String pGroup,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(ModBlocks.APIXELMELON_FURNACE_BLOCK.get());
    }
    ...
    public static class Type implements RecipeType<APixelMelonFurnaceRecipe> {
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<APixelMelonFurnaceRecipe> {
        private final int defaultCookingTime;
        public static final APixelMelonFurnaceRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public APixelMelonFurnaceRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new APixelMelonFurnaceRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public APixelMelonFurnaceRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, APixelMelonFurnaceRecipe pRecipe) {
