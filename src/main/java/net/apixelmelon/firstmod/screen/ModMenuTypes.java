...
public class ModMenuTypes {
    ...
    public static final RegistryObject<MenuType<APixelMelonFurnaceMenu>> APIXELMELON_FURNACE_MENU =
            registerMenuType("apixelmelon_furnace_menu", APixelMelonFurnaceMenu::new);
